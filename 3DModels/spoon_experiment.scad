...
difference(){
 ...
 scale([1.05,1.05,1.05])translate([-5,handle_length-10,-4])rotate([0,90,0])cylinder(r=4, h=5);
}
}
scale([1.05,1.05,1.05])translate([-4,handle_length-10,-4])rotate([0,90,0]) servo_standard();
}
